...
Release Notes:
Last Update : August 13, 2015 by Norman Morse
...
Release Notes
-------------
Version 2015.1/121.7416
- Some fixes to PendingChanges Dialog to remove Exceptions using GUIStyles
- Added Serialization Hooks to Config and PendingChanges Windows so they retain state during game runs.
- Fixed bug with Version String Passed to server on OSX
- Fixed some Unity 5.1.1 incompatibilities
- Improved option click commands in project view.
- Add, Revert and Checkout menu options now work on directories
- Added support for files which are already deleted in perforce.
- In automated builds (at Perforce) the Version string is automatically generated in Perforce style.
- In workshop builds, a Version string is generated from the CVS Keyword which tracks the Change ID.
- The Configuration Dialog was rewritten to be smaller and to better support resizing in both directions.
- The Configuration Dialog was improved and streamlined and broken into several tabbed
  Pages: "Connection", "Options" and "Diagnostics"
- Improved project root detection
- Changed ".bytes" entry in typemap from "text" to "binary".
- Rewrote AssetStatusCache to Cache AssetStatuses and FileMetaData
...
- Output P4Connect version to log during initialization.
